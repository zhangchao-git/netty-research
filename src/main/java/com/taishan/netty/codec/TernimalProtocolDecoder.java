...
public class TernimalProtocolDecoder extends MessageToMessageDecoder<ByteBuf> {
    ...
    protected void decode(ChannelHandlerContext ctx, ByteBuf byteBuf, List<Object> out) throws Exception {
        ...
        // 结尾校验 0xOD
        short headEnd = byteBuf.getShort(byteBuf.writerIndex() - 2);
        ...
        short checkSum = byteBuf.getShort(byteBuf.writerIndex() - 2);//排除校验码
        byteBuf.writerIndex(byteBuf.writerIndex() - 2);
        //TODO CRC校验
...
//        }
    ...
    public DataPacket parse(ByteBuf bb) {
        ...
        bb.markReaderIndex();
        short opCode = bb.getByte(bb.readerIndex() + 9);
        bb.resetReaderIndex();
        switch (opCode) {
